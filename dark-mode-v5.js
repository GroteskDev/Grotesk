function colorModeToggle() {
  ...
  window.addEventListener("DOMContentLoaded", (event) => {
    console.log('DOMContentLoaded event fired, initializing toggle button');
    toggleEl = document.querySelectorAll("[color-toggle]");
    if (toggleEl.length === 0) {
      console.warn('No toggle buttons found with [color-toggle] attribute!');
    } else {
      console.log('Toggle buttons found:', toggleEl);
    }
    toggleEl.forEach(function (element) {
